    ...
    <nav class="navbar sticky-top navbar-light bg-white shadow-sm w-100 z-index-1 border-top">
                <div class=" px-1 mx-auto">
                    <nav class="nav nav-secondary justify-content-center">
                        ...
                        <a class="nav-link text-secondary b-0" href="" @click.prevent="redirectPage('Input Schedule')">
                            <span class="d-sm-none" :class="{'textBold': $route.name === 'Input Schedule'}" title="Schedule">Sc</span>
                            <span class="d-none d-sm-block" :class="{'textBold': $route.name === 'Input Schedule'}">Schedule</span>
                        </a>
